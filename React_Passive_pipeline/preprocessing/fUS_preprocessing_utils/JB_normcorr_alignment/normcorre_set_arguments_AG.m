function globalArguments = normcorre_set_arguments_AG(globalArguments)
%{
...
%             grid_size = [size(raw_data,1),6]; %%% commented out because I prefer to set this within each loop
%             grid_size = [102,6]; %%% commented out because I prefer to set this within each loop
